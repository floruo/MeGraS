...
class BelowSpatialHandler : AbstractImplicitSpatialHandler(
    relationName = "below",
    filter = { segment1, segment2 ->
        segment1.below(segment2)
    }
)

class LeftSpatialHandler : AbstractImplicitSpatialHandler(
    relationName = "left",
    filter = { segment1, segment2 ->
        segment1.left(segment2)
    }
)
...
class TouchesSpatialHandler : AbstractImplicitSpatialHandler(
    relationName = "touches",
    filter = { segment1, segment2 ->
        segment1.touches(segment2)
    }
)
