...
class ClipServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTextEmbedding = channel.unary_unary(
                '/clip.ClipService/GetTextEmbedding',
        ...
        self.GetImageEmbedding = channel.unary_unary(
                '/clip.ClipService/GetImageEmbedding',
...
def add_ClipServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'clip.ClipService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('clip.ClipService', rpc_method_handlers)
